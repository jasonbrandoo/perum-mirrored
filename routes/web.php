...
Route::get('/test', function () {
  $surat = SuratPesanan::with('cicilan')->doesntHave('cicilan')->get();
  return $surat;
  // $pages = Page::all();
  // $user = Auth::user();
...
Route::group([
  ...
  Route::prefix('surat-pesanan')->group(function () {
    ...
    Route::get('/kreditur/{id}', 'Transaction\SuratPesanan\SuratPesananController@kreditur')->name('transaction.surat-pesanan.kreditur');
