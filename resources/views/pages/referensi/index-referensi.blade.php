...
<div>
  <a href="{{ route ('referensi.create') }}" class="btn btn-lg btn-primary"><i class="icon-plus-circle2 mr-2"></i>Add</a>
</div>
@endsection
        ...
        $('#role-table').DataTable({
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: (data, type, row) => `<a href="/referensi/${row.id}/edit">${row.reference_group}</a>`
                },
                {
