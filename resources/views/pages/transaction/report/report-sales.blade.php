...
@section('page-title')
<div class="mr-auto">
  <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Report</span> - Sales</h4>
...
<div class="card">
  ...
  <div class="card-body">
    <table class="table datatable-select-checkbox table-bordered text-center" id="penjualan-table">
      <thead>
        <tr>
          <th rowspan="2">Sales Executives</th>
...
var DatatableSelect = function() {
  var _componentDatatableSelect = function() {
    ...
    const table = $('#penjualan-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '{!! route('transaction.report.load_sales') !!}',
                type: 'POST',
                data: (data) => {
