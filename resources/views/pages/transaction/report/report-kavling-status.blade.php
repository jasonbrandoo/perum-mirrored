...
@section('page-title')
<div class="mr-auto">
  <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Report</span> - Report Kavling Status dan SP</h4>
  <a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
</div>
@endsection
 
@section('breadcrumb')
<a href="{{ route('transaction.report.kavling_status') }}" class="breadcrumb-item">Kavling Status dan SP</a>
@endsection
...
<div class="card">
  <div class="card-header header-elements-inline">
    <h5 class="card-title">Report Kavling Status dan SP</h5>
...
var DatatableSelect = function() {
  var _componentDatatableSelect = function() {
      ...
      const table = $('#penerimaan-table').DataTable({
          ...
          serverSide: true,
          ajax: {
              url: '{!! route('transaction.report.load_kavling_status') !!}',
              method: 'POST',
              data: (data) => {
