...
@section('page-title')
<div class="mr-auto">
  <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Report</span> - Report Piutang Summary</h4>
  <a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
</div>
@endsection
 
@section('breadcrumb')
<a href="{{ route('transaction.report.piutang_summary') }}" class="breadcrumb-item">Piutang Summary</a>
@endsection
...
<div class="card">
  <div class="card-header header-elements-inline">
    <h5 class="card-title">Report Piutang Summary</h5>
...
var DatatableSelect = function() {
  var _componentDatatableSelect = function() {
      ...
      const table = $('#penerimaan-table').DataTable({
          ...
          serverSide: true,
          ajax: {
              url: '{!! route('transaction.report.load_piutang_summary') !!}',
              method: 'POST',
              data: (data) => {
          ...
          columns: [
              ...
              {
                  data: 'kavling.house.rumah_type_name'
              },
              {
                  data: 'sp_total_bill',
