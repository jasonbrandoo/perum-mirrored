  ...
  <div class="page">
    <div class="__catatan">
      ...
      <div class="__point">
        ...
        <ol>
          <li><i>Dibayarkan/distorkan langsung ke Petugas Kasir <strong>PT. SARIII MULTIGRIYA SENTOSA</strong>di Kantor Proyek Perumahan Rajeg Gardenia dengan saudara/i yang sudah di tunjuk yaitu: <strong>Transfer</strong></i></li>
