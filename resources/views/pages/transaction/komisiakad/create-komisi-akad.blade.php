            ...
            <div class="form-group row">
              ...
              <div class="col-lg-9">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control pickadate-selectors" name="akad_date" value="{{isset($akad) ? $akad->akad_date->toDateString() : ''}}" required>
                </div>
              </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="col-lg-9">
                <select data-placeholder="Type" class="form-control form-control-select2" data-fouc name="akad_sp_id" id="sp_id" required>
                  @if (isset($akad))
                    <option value="{{$akad->surat->id}}">SP000{{$akad->surat->id}} - {{$akad->surat->customer->customer_name}} - BLOK {{$akad->surat->kavling->kavling_block}}</option>
                    @foreach ($surat as $sp)
            ...
            <div class="form-group row">
              ...
              <div class="col-lg-9">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control pickadate" id="sp_date" value="{{isset($akad) ? $akad->surat->sp_date->toDateString() : ''}}" required readonly>
                </div>
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-lg-9">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control pickadate-selectors" name="akad_ajb_date" value="{{isset($akad) ? $akad->akad_ajb_date->toDateString() : ''}}" required>
                </div>
              </div>
            </div>
            <div class="form-group row">
