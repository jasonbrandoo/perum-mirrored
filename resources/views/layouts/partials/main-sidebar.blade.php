          ...
          <ul class="nav nav-group-sub" data-submenu-title="Layouts">
            ...
            <li class="nav-item nav-item-submenu">
              ...
              <ul class="nav nav-group-sub">
                  ...
                  <li class="nav-item"><a href="{{ route('transaction.berkas.create') }}" class="nav-link"><i class="icon-plus2"></i>Create New Berkas</a></li>
              </ul>
            </li>
            {{--  --}}
            <li class="nav-item nav-item-submenu">
              ...
              <ul class="nav nav-group-sub">
                <li class="nav-item"><a href="{{ route('transaction.komisi-akad.create') }}" class="nav-link"><i class="icon-plus2"></i>Create New Akad</a></li>
            ...
            <li class="nav-item nav-item-submenu">
              ...
              <ul class="nav nav-group-sub">
                <li class="nav-item"><a href="{{ route('transaction.komisi-eksternal.create') }}" class="nav-link"><i class="icon-plus2"></i>Create New Komisi Eksternal</a></li>
            ...
            <li class="nav-item nav-item-submenu">
              ...
              <ul class="nav nav-group-sub">
                <li class="nav-item"><a href="{{ route('transaction.legal.create') }}" class="nav-link"><i class="icon-plus2"></i>Create New Legal</a></li>
            ...
            <li class="nav-item nav-item-submenu">
              ...
              <ul class="nav nav-group-sub">
                <li class="nav-item"><a href="#" class="nav-link"><i class="icon-plus2"></i>Create New LPA</a></li>
                <li class="nav-item"><a href="#" class="nav-link"><i class="icon-list"></i>LPA List</a></li>
              </ul>
            </li>
            {{--  --}}
            <li class="nav-item nav-item-submenu">
            ...
            <li class="nav-item nav-item-submenu">
              ...
              <ul class="nav nav-group-sub">
                ...
                <li class="nav-item"><a href="{{ route('transaction.realisasi.create') }}" class="nav-link"><i class="icon-plus2"></i>Create New Realisasi Wawancara</a></li>
                <li class="nav-item"><a href="{{ route('transaction.keputusan.create') }}" class="nav-link"><i class="icon-plus2"></i>Create New Keputusan</a></li>                
