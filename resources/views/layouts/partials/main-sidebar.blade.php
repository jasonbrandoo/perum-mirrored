        ...
        <li class="nav-item nav-item-submenu">
          ...
          <ul class="nav nav-group-sub" data-submenu-title="Layouts">
            ...
            <li class="nav-item nav-item-submenu">
              ...
              <ul class="nav nav-group-sub">
                <li class="nav-item"><a href="#" class="nav-link"><i class="icon-plus2"></i>Create New Akad</a></li>
                <li class="nav-item"><a href="#" class="nav-link"><i class="icon-list"></i>Komisi Akad List</a></li>
              </ul>
            </li>
            <li class="nav-item nav-item-submenu">
              <a href="#" class="nav-link">Komisi Eksternal</a>
              <ul class="nav nav-group-sub">
                <li class="nav-item"><a href="#" class="nav-link"><i class="icon-plus2"></i>Create New Eksternal</a></li>
                <li class="nav-item"><a href="#" class="nav-link"><i class="icon-list"></i>Komisi Eksternal List</a></li>
              </ul>
            </li>
            <li class="nav-item nav-item-submenu">
            ...
            <li class="nav-item nav-item-submenu">
              ...
              <ul class="nav nav-group-sub">
                <li class="nav-item"><a href="#" class="nav-link"><i class="icon-plus2"></i>Create New Result</a></li>
                <li class="nav-item"><a href="#" class="nav-link"><i class="icon-list"></i>Result List</a></li>
              </ul>
            </li>
            <li class="nav-item nav-item-submenu">
